...
//Valutakilde = Den europeiske sentralbank (ESB)
const initiallyDisplayedCurrencies = ["NOK", "EUR", "SEK", "DKK", "GBP"];
let baseCurrency;
let baseCurrencyAmount;

let currencies = [
// Se https://no.wikipedia.org/wiki/ISO_4217 for valutakoder og -navn.
  {
    name: "Norsk kroner",
    abbreviation: "NOK",
    symbol: "\u006B\u0072",
